...
class AuthController extends Controller
{
    ...
    public function handleGoogleCallback(Request $request)
    {
        ...
        try {
            ...
            if (!$usuario->activo) {
                app(\App\Services\NoSqlLoggerService::class)->log("Intento de inicio de sesiÃ³n en cuenta desactivada (Google)", 'warning', ['email' => $usuario->email], $usuario->id);
            ...
            app(\App\Services\NoSqlLoggerService::class)->log("Error al procesar inicio de sesiÃ³n con Google", 'error', ['error' => $e->getMessage()]);
