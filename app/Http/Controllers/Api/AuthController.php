...
class AuthController extends Controller
{
    ...
    /**
     * Obtiene la informaci�n del usuario desde Google.
     */
    public function handleGoogleCallback(Request $request)
    {
        ...
        try {
            ...
            $usuario = DB::transaction(function () use ($user, $googleUser) {
                ...
                // Actualiza la foto del cliente si est� vac�a
            ...
            // Solo enviamos el token en una cookie (sin datos del usuario para evitar headers grandes)
